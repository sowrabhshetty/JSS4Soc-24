...
def getInfo():
    # name=input("Name:")
    print("Your Name \n\t\t\t\t\t\t",end="->")
    readn(f"Please enter your name")
    name=input("")
    print("hello ",name)
    readn(f"hello {name}")
...
def tree_to_code(tree, feature_names):
    ...
    while True:
        ...
        readn(f"Enter the symptom you are experiencing")
        disease_input = input("")
        ...
        if conf==1:
            ...
            readn(f"Enter valid symptom.")

    while True:
        try:
            readn(f"Okay. From how many days?")
    ...
    def recurse(node, depth):
        ...
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            readn(f"Are you experiencing any")
            symptoms_exp=[]
            for syms in list(symptoms_given):
                ...
                while True:
                    ...
                    if(inp=="yes" or inp=="no"):
                        ...
                        readn(f"Please provide proper answers either yes or no")
                if(inp=="yes"):
            ...
            if(present_disease[0]==second_prediction[0]):
                ...
                readn(f"You may have {present_disease[0]} or {second_prediction[0]}")
                readn(f"{description_list[present_disease[0]]}")
